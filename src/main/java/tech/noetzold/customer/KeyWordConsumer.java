...
public class KeyWordConsumer {
    ...
    @Merge
    @Blocking
    public KeyWordModel process(JsonObject incomingKeyWordModelInJson) {

        KeyWordModel incomingKeyWordModel = incomingKeyWordModelInJson.mapTo(KeyWordModel.class);
